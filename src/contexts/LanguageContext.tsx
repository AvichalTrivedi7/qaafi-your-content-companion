...
const translations: Translations = {
  ...
  'admin.systemDashboard': { en: 'System Dashboard', hi: 'सिस्टम डैशबोर्ड' },
  'admin.systemDashboardSubtitle': { en: 'Platform-wide overview and monitoring', hi: 'प्लेटफ़ॉर्म-व्यापी अवलोकन और निगरानी' },
  'admin.totalUsers': { en: 'Total Users', hi: 'कुल उपयोगकर्ता' },
  'admin.recentActivities': { en: 'Recent Activities', hi: 'हाल की गतिविधियाँ' },
  'admin.last24Hours': { en: 'last 24 hours', hi: 'पिछले 24 घंटे' },
  'admin.globalActivityLog': { en: 'Global Activity Log', hi: 'वैश्विक गतिविधि लॉग' },
  'admin.users': { en: 'Users', hi: 'उपयोगकर्ता' },
  'admin.usersSubtitle': { en: 'View all registered users in the system', hi: 'सिस्टम में सभी पंजीकृत उपयोगकर्ता देखें' },
  ...
  'admin.roles': { en: 'Roles', hi: 'भूमिकाएं' },
  'admin.joinedDate': { en: 'Joined', hi: 'शामिल हुए' },
  'admin.activityLog': { en: 'Activity Log', hi: 'गतिविधि लॉग' },
  'admin.activityLogSubtitle': { en: 'View all system activity across companies', hi: 'सभी कंपनियों की सिस्टम गतिविधि देखें' },
  'admin.searchActivity': { en: 'Search activity...', hi: 'गतिविधि खोजें...' },
